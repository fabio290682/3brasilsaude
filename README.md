...
- `docker-deploy` constrói e envia a imagem Docker para o Docker Hub quando um push é feito em `main`

Para usar o deploy automático, configure os segredos do GitHub:
- `DOCKERHUB_USERNAME`
- `DOCKERHUB_TOKEN`
